/*
    ...
    OpenGL loader generated by glad 0.1.9a3 on Sat Jan  2 15:10:48 2016.
    ...
    Commandline:
        --profile="compatibility" --api="gl=3.0" --generator="c" --spec="gl" --no-loader --extensions="GL_ARB_timer_query,GL_ARB_uniform_buffer_object"
    Online:
        http://glad.dav1d.de/#profile=compatibility&language=c&specification=gl&api=gl%3D3.0&extensions=GL_ARB_timer_query&extensions=GL_ARB_uniform_buffer_object
*/
