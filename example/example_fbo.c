...
void renderPattern(NVGcontext* vg,
                   NVGLUframebuffer* fb,
                   float t,
                   float pxRatio)
{
...
int main()
{
    ...
    //	window = glfwCreateWindow(1000, 600, "NanoVG",
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        {
            NVGpaint img =
                nvgImagePattern(vg, 0, 0, 100, 100, 0, fb->image, 1.0f);
            nvgSave(vg);
