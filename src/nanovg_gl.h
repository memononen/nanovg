...
int nvglCreateImageFromHandleGL2(
...
int nvglCreateImageFromHandleGL3(
    NVGcontext* ctx, GLuint textureId, int w, int h, int flags);
...
int nvglCreateImageFromHandleGLES2(
    NVGcontext* ctx, GLuint textureId, int w, int h, int flags);
...
int nvglCreateImageFromHandleGLES3(
    NVGcontext* ctx, GLuint textureId, int w, int h, int flags);
...
static int glnvg__createShader(GLNVGshader* shader,
                               const char* name,
                               const char* header,
                               const char* opts,
                               const char* vshader,
...
static int glnvg__renderCreateTexture(void* uptr,
                                      int type,
                                      int w,
                                      int h,
                                      int imageFlags,
                                      const unsigned char* data)
{
        ...
        glnvg__nearestPow2(h) != (unsigned int) h)
    {
        ...
        {
            printf("Repeat X/Y is not supported for non power-of-two "
                   "textures (%d x %d)\n",
                   w,
                   h);
        ...
        {
            printf("Mip-maps is not support for non power-of-two textures "
                   "(%d x %d)\n",
                   w,
                   h);
...
static int glnvg__convertPaint(GLNVGcontext* gl,
...
static void glnvg__renderViewport(void* uptr,
                                  int width,
                                  int height,
