...
void glnvg__renderFill(GLNVGcontext* gl, NVGpaint* paint, NVGscissor* scissor, float fringe,
...
void glnvg__renderStroke(GLNVGcontext* gl, NVGpaint* paint, NVGscissor* scissor, float fringe,
...
void glnvg__renderTriangles(GLNVGcontext* gl, NVGpaint* paint, NVGscissor* scissor,
